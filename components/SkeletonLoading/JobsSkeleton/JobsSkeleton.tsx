          ...
          <div className="lg:col-span-8 space-y-4  ">
            ...
            <div className="grid grid-cols-5 w-full border  border-gray-100 bg-white p-4 gap-4 rounded-xl justify-start items-start  hover:bg-slate-100 focus:bg-gray-100 transition-colors">
              <div className="col-span-1 ml-3 flex justify-center items-center place-content-center place-items-center">
                <div className="lg:w-[150px] md:w-32 w-[90px] lg:h-24 md:h-24 h-[70px] bg-slate-200 animate-pulse rounded-xl"></div>
              </div>

              {/* Text Section */}
              <div className="col-span-3  lg:space-y-3 md:space-y-4 cursor-pointer">
                <div className="lg:w-60 md:w-60 w-[200px] lg:h-6 md:h-5 h-[20px] bg-slate-200 animate-pulse rounded-xl"></div>
                <div className="lg:w-80 md:w-60 w-[200px] lg:h-5 md:h-4 h-[20px] bg-slate-200 animate-pulse rounded-xl"></div>
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="lg:w-20 md:w-20 w-[200px] lg:h-5 md:h-4 h-[20px] bg-slate-200 animate-pulse rounded-xl"></div>
                  <div className="lg:w-32 md:w-20 w-[200px] lg:h-5 md:h-4 h-[20px] bg-slate-200 animate-pulse rounded-xl"></div>
                </div>
              </div>
              <div className="col-span-1  space-y-[65px] ">
                {/*bookmark*/}
                <div className="flex justify-end text-lime-300">
                  <div className="lg:w-6 md:w-6 w-[200px] lg:h-6 md:h-6 h-[20px] bg-slate-200 animate-pulse rounded-xl"></div>
                </div>
