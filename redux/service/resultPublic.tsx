...
// export const resultPublicApi = normPlovApi.injectEndpoints({
//   endpoints: (builder) => ({
...
//         url: `api/v1/test/public/${testUUID}`, // Dynamic query parameter
//         method: 'GET',
//       }),
...
// export const { useFetchAssessmentDetailsQuery,useGetTestDetailQuery } = resultPublicApi;
